...
public class Big_w_receiver extends ReceiverAdapter {
    private int currentLine;
    private LinesManager editorLineManager;
    private String targetFilePath;

    public Big_w_receiver(CommandSQL commandSQL) {
        super(commandSQL);
    ...
    public void doAction() {
        ...
        try {
            ...
            if (tmp.equals("")) {
                AddressAnalyser.listToFile(editorLineManager.getLines().subList(beginIndex - 1, endIndex), new File(this.targetFilePath), true);
            } else {
                AddressAnalyser.listToFile(editorLineManager.getLines().subList(beginIndex - 1, endIndex), new File(tmp), true);
            }
